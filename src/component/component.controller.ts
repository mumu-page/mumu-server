...
export class ComponentController {
  constructor(private readonly userService: ComponentService) { }
  ...
  */
  ...
  async addComponent(
    ...
    return this.userService.addComponent(body, manager);
  }
  /* 
    查询单个详情
    @Query ?id=xxx
  ...
  async updateComponent(
    ...
    return this.userService.updateComponent(body, manager);
  }

  @Get('query')
  query(@Query() query): Promise<Project> {
